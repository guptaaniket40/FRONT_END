...
function Aeditprofile() {
    ...
    const getsubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`http://localhost:3000/admin/${localStorage.getItem("Aid")}`, form)
            ...
            toast.error("Failed to update profile. Please check if the admin exists.")
        }
