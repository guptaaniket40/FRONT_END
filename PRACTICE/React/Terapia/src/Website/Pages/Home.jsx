...
function Home() {
    ...
    return (    
        <div>
            <Header />
            <Helmet>
                {/* jQuery and Bootstrap 5 Bundle from CDN (recommended for common libraries) */}
                <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
                <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>

                {/* Local scripts:
                  Ensure these files are located in your 'public' folder relative to their paths.
                  For example, 'lib/wow/wow.min.js' should be at 'public/lib/wow/wow.min.js'.
                  
                  Consider migrating the functionality of these scripts into React-specific
                  solutions or components if they perform DOM manipulation that conflicts with React.
                */}
                ...
                {/* Your main.js script:
                  This is the most critical one to review. If main.js directly manipulates the DOM
                  that React is managing, you'll likely encounter issues. Ideally, its logic
                  should be re-implemented using React hooks and component state.
                */}
